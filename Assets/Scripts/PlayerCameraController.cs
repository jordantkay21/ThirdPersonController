...
public class PlayerCameraController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _inputHandler = _syntyCharacter.GetComponent<InputReader>();
    ...
    private void Update()
    {
        ...
        _rotationX = _inputHandler._mouseDelta.y * _cameraInversion * _mouseSensitivity;

        _rotationY = _inputHandler._mouseDelta.x * _mouseSensitivity;
